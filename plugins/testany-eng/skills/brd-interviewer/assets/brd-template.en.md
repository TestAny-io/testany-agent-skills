...
>
> Generated from interviews or supplied materials. Record actual sources; examples and placeholders are not facts or approval.
...
| Status | draft; change only with actual evidence for this version and scope |
...
| Indicator | Evidence type | Current value / unknown | Target and basis | Time window | Source / estimation basis |
|-----------|---------------|-------------------------|------------------|-------------|---------------------------|
| {Indicator} | measured / estimated / measurement_plan | {Sourced value or unknown} | {Sourced target or pending} | {Known or pending} | {Actual source} |

A missing historical baseline does not block a draft. Never guess values to complete this table. Use applicable measurement plans or discrete acceptance, not a mandatory numeric metric for every requirement.

| Unknown | Measurement method / scope | Owner | Time / trigger | Decision supported |
|---------|----------------------------|-------|----------------|--------------------|
| {Unknown} | {Plan} | {Known or pending} | {Known or pending} | {Baseline/target decision} |

| Discrete acceptance | Scenario | Observable pass/fail condition | Acceptor / evidence |
|---------------------|----------|--------------------------------|---------------------|
| {discrete_acceptance} | {Business scenario} | {Condition} | {Known or pending} |
...
Record only actual approval applicable to this version/scope. Complete materials or a generated document are not approval; leave pending rather than inventing names, dates or decisions.
