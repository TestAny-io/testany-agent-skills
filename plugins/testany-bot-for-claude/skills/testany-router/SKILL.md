...
| Jenkins/GitHub Actions/GitLab/CI/CD/门禁/gatekeeper/quality gate | `test-orchestrator` | "接入我们的 CI"、"setup quality gate" |
| 定时/计划/cron/schedule/plan | `test-orchestrator` | "每天凌晨 2 点执行"、"schedule daily run" |
